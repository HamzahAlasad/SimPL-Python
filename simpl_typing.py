...
class ArrowType(Type):
    ...
    def replace(self, a, t): return ArrowType(
        self.t1.replace(a, t), self.t2.replace(a, t))
...
class PairType(Type):
    ...
    def is_equality_type(self): return self.t1.is_equality_type(
    ) and self.t2.is_equality_type()
    ...
    def contains(self, tv): return self.t1.contains(tv) or self.t2.contains(tv)
    def replace(self, a, t): return PairType(
        self.t1.replace(a, t), self.t2.replace(a, t))
